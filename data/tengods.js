...
const TEN_GODS_GLOSSARY = {
  'zheng_guan': {
    ...
    ancientCanonEn: 'Reinhold Ebertin\'s Cosmobiology (Saturn-Jupiter Structural Axis) & William Lilly\'s Dignities: "Direct Officer embodies institutional legitimacy, lawful order, and constitutional authority. When the core self is fortified by systemic resources and sustained by pragmatic wealth, untarnished by disruptive impulses, it yields supreme administrative dignity and public stature."',
  ...
  'qi_sha': {
    ...
    ancientCanonEn: 'Reinhold Ebertin\'s Mars-Pluto Dynamic Tension & Hellenistic Sect Doctrine: "Seven Killings is the ferocious catalytic vector that tests the limits of systemic endurance. When tempered by specialized intellectual skill or transmuted through institutional depth, aggressive friction is converted into martial brilliance and crisis leadership."',
  ...
  'zheng_cai': {
    ...
    ancientCanonEn: 'Reinhold Ebertin\'s Earth-Mercury Pragmatism & Keplerian Harmonic Proportions: "Direct Wealth represents the steady compound accumulation of tangible value through empirical diligence, disciplined stewardship, and contractual integrity. It demands a robust baseline to deploy; without structural vigor, excessive resource burden causes systemic strain."',
  ...
  'pian_cai': {
    ...
    ancientCanonEn: 'John M. Addey\'s 5th Harmonic Speculative Vector & Dane Rudhyar\'s Phase Innovation: "Indirect Wealth operates across the open commercial commons. Spirited, visionary, and fluid, it commands high-velocity capital circulation, venture arbitrage, and expansive cross-sector alliances riding macroeconomic tailwinds."',
  ...
  'zheng_yin': {
    ...
    ancientCanonEn: 'Hellenistic Benefic Sanctuary & C.G. Jung\'s Archetypal Matriarch: "Direct Resource functions as the primordial cognitive fountainhead and institutional aegis. It bestows scholarly distinction, psychological tranquility, ethical stature, and impenetrable protective pedigree."',
  ...
  'pian_yin': {
    ...
    ancientCanonEn: 'Johannes Kepler\'s 7th Harmonic Non-Rational Insight & Ebertin\'s Uranus-Neptune Axis: "Indirect Resource commands transcendent intuition, asymmetric logic, and deep structural penetration. Operating in autonomous solitude, it unmasks hidden anomalies and cracks paradoxes beyond conventional paradigms."',
  ...
  'shi_shen': {
    ...
    ancientCanonEn: 'Dane Rudhyar\'s Crescent Phase Generative Flow & Addey\'s 9th Harmonic Joy: "Eating God is the harmonious radiant outpouring of vital essence—the pristine wellspring of regenerative wealth and physiological longevity. It embodies artistic grace, calm emotional intelligence, and timeless craftsmanship."',
  ...
  'shang_guan': {
    ...
    ancientCanonEn: 'The Promethean Archetype & Ebertin\'s Mars-Uranus Breakthrough Vector: "Hurting Officer is daring in vision and revolutionary in execution. When grounded by structural resources or channelled into commercial innovation, it shatters ossified orthodoxies and commands epochal creative influence."',
  ...
  'bi_jian': {
    ...
    ancientCanonEn: 'Hermetic Parity & Robert Hand\'s Co-linear Vector Synthesis: "Friend embodies egalitarian comradeship, unvarnished integrity, and bedrock self-reliance. Standing firmly upon its own axis without leaning on ancestral privilege, it defends sovereign autonomy through steadfast toil."',
  ...
  'jie_cai': {
    ...
    ancientCanonEn: 'Evolutionary Game Dynamics & Dynamic Competitive Vectors: "Rob Wealth embodies frontline martial combat and raw competitive drive. Bold, decisive, and charismatic, it mobilizes legions into contested arenas; when disciplined by governance, it captures dominant market ground."',
