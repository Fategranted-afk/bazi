...
const I18N = (function() {
  const dict = {
    zh: {
      ...
      advisor_verifier_status_added: "已校验增补自定义动作：",
    ...
    en: {
      ...
      advisor_verifier_status_confirmed: "Confirmed aligned with current reality, proceeding in order.",
      advisor_verifier_status_added: "Verified & added custom actions: ",
