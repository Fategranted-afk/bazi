...
const I18N = (function() {
  const dict = {
    zh: {
      ...
      portal_card10_desc: "东汉末年至唐初贞观 · 416位风云人物 · 性格位置生平胜负手 · 相似度测算与学戒大略",
      portal_history_title: "历史人物参考 (东汉至唐初贞观)",
      portal_history_desc: "东汉三国、西晋八王、十六国、东晋、南北朝、北魏、周齐、隋朝至唐初贞观 · 416位风云人物相似度测算",
      history_banner_title: "历史人物参考 · 历史名人人格镜像",
      history_banner_desc: "夫以铜为镜，可以正衣冠；以古为镜，可以知兴替；以人为镜，可以明得失。融汇东汉三国、西晋、五胡十六国、东晋、南北朝、北魏、东西魏、周齐、隋朝至唐初贞观四百一十六位历史风云人物 · 相似度测算与学戒大略。",
      ...
      history_panorama_title: "四、全景历史人物长卷（416位历史人物名录）",
      history_counter_badge: "共收录 416 位风云人物",
    ...
    en: {
      ...
      portal_card10_desc: "Eastern Han to Early Tang · 416 Historical Titans · Personality, Archetype & Deeds · Similarity & Guidance",
      portal_history_title: "Historical Figures Reference & Mirror",
      portal_history_desc: "Eastern Han, Three Kingdoms, Western Jin, 16 Kingdoms, Eastern Jin, Southern Dynasties, Northern Wei, Zhou/Qi, Sui to Tang · 416 Archetypes",
      history_banner_title: "Historical Figures Reference · Archetype Mirror",
      history_banner_desc: "Using bronze as a mirror to dress; using history to know the rise and fall; using persons to discern right and wrong. Comparing your Day Master and patterns against 416 historical titans to derive strategic guidance and behavioral circuit-breakers.",
      ...
      history_panorama_title: "4. Historical Panorama (416 Historical Figures Catalog)",
      history_counter_badge: "416 Historical Titans Curated",
