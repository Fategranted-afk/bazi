...
const I18N = (function() {
  const dict = {
    zh: {
      ...
      dossier_generating: "⏳ 正在编译 7 页钦天监 · 御制天机 A4 珍藏册 PDF，请稍候...",
      ...
      // Historical Figures Reference (南北乱世三百年)
      nav_view_history: "📜 历史人物参考 (南北乱世300年)",
      seal_view_history: "史鉴推演",
      portal_card10_title: "历史人物参考 (南北乱世300年)",
      portal_card10_desc: "西晋八王至大隋统一 · 104位风云人物 · 性格位置生平胜负手 · 相似度测算与学戒大略",
      portal_history_title: "历史人物参考 (南北乱世三百年)",
      portal_history_desc: "西晋八王之乱、五胡十六国、东晋门阀、南北朝、北魏、东西魏、周齐至大隋统一 · 104位风云人物相似度测算",
      history_banner_title: "历史人物参考 · 南北乱世三百年人物镜像",
      history_banner_desc: "夫以铜为镜，可以正衣冠；以古为镜，可以知兴替；以人为镜，可以明得失。融汇西晋、五胡十六国、东晋、南北朝、北魏、东西魏、周齐至大隋一百零四位历史风云人物 · 相似度测算与学戒大略。",
      ...
      history_panorama_title: "四、乱世三百年全景历史人物长卷（104位历史人物名录）",
      history_counter_badge: "共收录 104 位风云人物",
    ...
    en: {
      ...
      dossier_generating: "⏳ Compiling 7-Page Qin Tian Jian Imperial Celestial Blueprint A4 PDF...",
      ...
      // Historical Figures Reference (300 Years of Division)
      nav_view_history: "📜 Historical Figures Reference",
      seal_view_history: "Historical Mirror",
      portal_card10_title: "Historical Figures Reference (300 Years)",
      portal_card10_desc: "Western Jin to Sui Dynasty · 104 Historical Titans · Personality, Archetype & Deeds · Similarity & Guidance",
      portal_history_title: "Historical Figures Reference & Mirror",
      portal_history_desc: "Western Jin, Sixteen Kingdoms, Eastern Jin, Southern Dynasties, Northern Wei, Zhou/Qi to Sui · 104 Archetypes",
      history_banner_title: "Historical Figures Reference · 300-Year Archetype Mirror",
      history_banner_desc: "Using bronze as a mirror to dress; using history to know the rise and fall; using persons to discern right and wrong. Comparing your Day Master and patterns against 104 historical titans to derive strategic guidance and behavioral circuit-breakers.",
      ...
      history_panorama_title: "4. 300-Year Historical Panorama (104 Historical Figures Catalog)",
      history_counter_badge: "104 Historical Titans Curated",
