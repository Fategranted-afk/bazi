...
const I18N = (function() {
  const dict = {
    ...
    en: {
      ...
      rectify_rationale_desc: "Chinese metaphysics allocates two hours to each double-hour pillar. If birth time is near the cusp (e.g. 12:50-13:10), unadjusted for true solar time, or vaguely remembered, the hour pillar changes drastically, altering dominant patterns and favorable gods. Event-based rectification uses confirmed past life events to calculate Bayesian posterior probabilities across candidate hours to recover the authentic natal blueprint.",
