...
const I18N = (function() {
  const dict = {
    zh: {
      ...
      advisor_tab_chat: "军师策问",
      advisor_tab_ledger: "战术账本",
      advisor_back_to_chat: "返回问对",
      advisor_prompts_hint: "点击锦囊直击现实核心困境",
      advisor_ledger_btn: "动作账本",
      advisor_ledger_title: "闭环微动作战术账本",
      advisor_ledger_sub: "追踪微动作执行闭环，实时动态反哺军师决策阻抗",
      advisor_ledger_stats_total: "总计",
      advisor_ledger_stats_pending: "待办",
      advisor_ledger_stats_executed: "已办",
      advisor_ledger_stats_eased: "见效",
      advisor_ledger_stats_blocked: "遇阻",
      advisor_ledger_stats_neutral: "平稳",
      advisor_ledger_clear: "清空账本",
      advisor_ledger_empty: "暂无微动作记录。军师每次参谋生成的微动作将自动收录于此。",
      advisor_tool_audit_title: "确定性工具审计中枢",
      advisor_tool_audit_sub: "纯数理与经典格局推演 · 拒绝黑箱幻觉",
      advisor_feedback_prompt: "1-Click执行反馈",
      advisor_feedback_eased: "缓和见效",
      advisor_feedback_blocked: "遭遇阻力",
      advisor_feedback_neutral: "平稳中和",
      advisor_recalibration_title: "动态闭环校准态",
      advisor_situation_align_title: "现实处境贴合度校准",
      advisor_situation_align_prompt: "以上战术锦囊与落地微动作，是否切合您当下的实际现实处境（如现金流储备、领导风格、时间精力、制约痛点）？",
      advisor_situation_agree_btn: "非常贴合，直接照此执行",
      advisor_situation_refine_btn: "补充我的具体处境（请求细致建议）",
      advisor_situation_input_label: "请简要描述您当前的现实处境与制约条件（例如：部门裁员、手头存款、领导关系、备考时间等）：",
      advisor_situation_placeholder: "例如：部门正在裁员，存款只够维持5个月，领导推诿抢功严重，准备考公但精力不够...",
      advisor_situation_submit_btn: "生成因地制宜细致建议",
      advisor_situation_cancel_btn: "取消",
      advisor_situation_confirmed: "已确认贴合实际处境，正照此执行。",
      advisor_situation_badge: "处境定制",
      advisor_situation_active_prefix: "当前已对齐现实处境：",
      advisor_situation_banner_hint: "描述您的具体处境（资金、人际、时间阻力），让军师生成因地制宜的精细化战术与定制微动作。",
      advisor_situation_btn_input: "录入具体处境定制",
      advisor_situation_btn_update: "更新处境",
      advisor_ledger_filter_all: "全部",
      advisor_ledger_filter_pending: "待办打卡",
      advisor_ledger_filter_executed: "已完成",
      advisor_ledger_filter_situational: "处境定制",
      advisor_ledger_mark_all_done: "一键全选打卡",
      advisor_ledger_add_custom: "增订微动作",
      advisor_ledger_custom_title: "增订个性化微动作（生成专属 Checkbox 待办打卡）",
      advisor_verifier_title: "微动作处境校验 · 用户审定与增补",
      advisor_verifier_prompt: "以上行动项未必100%切合您当前的即时处境。您是否有想要增加、调整或个性化补充的行动项？",
      advisor_verifier_confirm_btn: "契合现状，无需增补",
      advisor_verifier_add_btn: "增加 / 自定义微动作",
      advisor_verifier_input_label: "请输入您想要补充的具体打卡行动项（生成专属 Checkbox）：",
      advisor_verifier_placeholder: "例如：每晚10点后加练真题1套，或每周四前向导师汇报进度，规避与某同事发生口角...",
      advisor_verifier_notify_advisor: "同步让军师基于此增订项微调后续战策",
      advisor_verifier_submit_btn: "确认添加并更新清单",
      advisor_verifier_status_confirmed: "已确认契合现状，正有序推进。",
      career_subpage_nav_label: "职场三大高维破局中枢：",
      career_tab_title_overview: "职场全相与财运推演",
      career_tab_badge_overview: "身命破局",
      career_tab_desc_overview: "向上管理 · 同僚防火墙 · 正偏财时序",
      career_tab_title_simulator: "现实决策 · 双轨对抗推演沙盘",
      career_tab_badge_simulator: "胜负对决",
      career_tab_desc_simulator: "方案A/B胜负对抗 · 胜率能耗比 · 地理风水",
      career_tab_title_matrix: "组织多方博弈政治矩阵",
      career_tab_badge_matrix: "权力克应",
      career_tab_desc_matrix: "3~5人非零和网络 · 十神有向权力图",
      career_subpage_note: "三大高维决策中枢 · 毫秒级直达推演",
      ...
      sim_subpage_nav_label: "⚖️ 胜负沙盘专属副页面：",
      sim_tab_title_sandbox: "双轨全息推演沙盘",
      sim_tab_badge_sandbox: "胜负对决",
      sim_tab_title_georesonance: "地理方位与组织生态匹配仪",
      sim_tab_badge_georesonance: "生态定位",
      sim_tab_title_fengshui: "空间风水指南 · 实操调理十策",
      sim_tab_badge_fengshui: "空间开运",
      sim_subpage_note: "对标十二大典独立副页面架构 · 三大高维决策中枢",
      tab_fric_specs: "🧘 《原厂心智说明》",
      tab_fric_specs_badge: "硬件体检",
      tab_fric_zen: "☸️ 《禅道三经至理》",
      tab_fric_zen_badge: "金刚·坛经·庄子",
      tab_fric_canons: "📜 《八典对症细注》",
      tab_fric_canons_badge: "正统赋文",
      tab_fric_triggers: "⚡ 《极端压力红线》",
      tab_fric_triggers_badge: "触发开关",
      tab_fric_protocols: "🛡️ 《自救三阶降维》",
      tab_fric_protocols_badge: "硬重启法",
      tab_fric_habits: "🌿 《五行微习惯》",
      tab_fric_habits_badge: "身心调理",
      tab_fric_iching: "☯️ 《周易文王六十四卦》",
      tab_fric_iching_badge: "易道神机",
      tab_fric_all: "📑 《全卷通览》",
      tab_fric_all_badge: "全篇顺读",
      ...
      btn_ribbon_ledger: "📋 待办打卡清单",
      btn_ribbon_ledger_text: "待办打卡清单",
      floating_ledger_btn: "待办打卡",
      ...
      // In-Page Rectification Workbench Keys
      rectify_inpage_title: "以事校对 · 命盘准确度校准中枢",
      seal_rectification: "以事校对",
      rectify_inpage_sub: "若您觉得核心主盘格局、六亲或大势推演与真实人生有出入，多因出生时辰交界模糊；可通过2~3件既往关键事件逆推真命时辰，一键采纳并重算主盘。",
      btn_toggle_rectify_workbench: "展开校对工作台",
      btn_toggle_rectify_workbench_collapse: "收起校对工作台",
      rectify_rationale_title: "为什么主盘推演可能不准？（时辰临界与以事校对原理）",
      rectify_rationale_desc: "八字以两个小时为一个时辰。若出生时间处于时辰交界（如 12:50~13:10）、或医院手表时间未校正真太阳时、或长辈记忆偏差，时柱干支便可能错位，导致统帅格局、十神用神发生质变。以事校对通过您已经发生的真实人生大事件（如金榜题名、重大伤病、婚恋置业等），运用贝叶斯后验概率逆推最匹配的时辰，确保推演坚实可信。",
      rectify_step1_sync_hint: "自动同步",
      btn_load_sample_events: "⚡ 载入典型事件范例",
      rectify_approx_hour: "大致出生时辰范围",
      rectify_opt_all_hours: "全天12时辰全域扫描 (All 12 Double-Hours)",
      rectify_opt_morning: "早晨 (卯辰巳 05:00-11:00)",
      rectify_opt_afternoon: "下午 (午未申 11:00-17:00)",
      rectify_opt_evening: "傍晚入夜 (酉戌亥 17:00-23:00)",
      rectify_opt_night: "深夜子丑 (子丑寅 23:00-05:00)",
      rectify_event_year: "发生公历年份",
      rectify_event_type: "事件性质类别",
      rectify_event_desc: "简要备注（选填）",
      rectify_type_exam: "高考金榜 / 重大考学跃升 (Academic / Exam)",
      rectify_type_illness: "重大手术 / 意外伤灾 (Surgery / Illness)",
      rectify_type_marriage: "结婚成家 / 缔结契约 (Marriage / Union)",
      rectify_type_child: "生儿育女 / 添丁添喜 (Childbirth)",
      rectify_type_career_jump: "职业跃迁 / 破格提拔 (Major Promotion)",
      rectify_type_wealth_loss: "破财被骗 / 投资折戟 (Wealth Loss / Debt)",
      rectify_type_relocation: "跨国远徙 / 重大动迁 (Relocation / Move)",
      btn_run_rectification: "启动贝叶斯最大后验概率逆推 (Compute MAP Rectification)",
      rectify_check_prompt: "推演结果与您的实际经历存在出入？",
      rectify_check_tag: "准确度校准",
      ...
      phase_portrait_title: "时空动力学相空间与生命螺旋流形 (Life-Chrono Spiral Manifold)",
      phase_portrait_sub: "以用户日主为固定衡量系展开的 3D 时空动力学螺旋轨迹：从 1 岁起点出发，洞察一生的势能起伏、螺旋上升与筑底跃迁",
      phase_param_rigidity: "格局刚性 (a · 日元抗压自持力):",
      phase_param_bifurcation: "双稳态分岔 (b · 势能跃迁潜质):",
      phase_param_bias: "大运偏压 (c · 岁运外部推力):",
      phase_param_damping: "耗散阻尼 (γ · 印星缓冲护城河):",
      phase_btn_reset: "重置动力学参数",
      phase_legend_axis_x: "横轴: 岁月前进时间纵深 (1y -> 100y) 与能量投射位移",
      phase_legend_axis_v: "纵轴: 势能水位与动量升降 (螺旋上升 / 筑底蓄势)",
      phase_legend_origin: "1y 起点 · 元神初生",
      phase_legend_spring: "1~25y 萌芽",
      phase_legend_summer: "26~50y 鼎盛",
      phase_legend_autumn: "51~75y 沉淀",
      ...
      dossier_download_btn: "📥 直接下载全相 PDF (9页)",
      dossier_print_btn: "🖨️ 系统打印 / 另存为 PDF",
      dossier_close_btn: "关闭预览",
      dossier_generating: "⏳ 正在编译 9 页钦天监 · 御制天机 A4 珍藏册 PDF，请稍候...",
      dossier_generating_single: "⏳ 正在快速编译第 1 页（卷首总目目录）单页 A4 PDF，请稍候...",
      ...
      portal_card10_desc: "东汉末年至唐初贞观与近代西方 · 549位风云人物 · 性格位置生平胜负手 · 相似度测算与学戒大略",
      portal_history_title: "历史人物参考 (东汉至唐初贞观及近代西方)",
      portal_history_desc: "东汉三国至隋唐贞观449位先贤与近代西方100位风云人物 · 549位风云人物相似度测算",
      history_banner_title: "历史人物参考 · 历史名人人格镜像",
      history_banner_desc: "夫以铜为镜，可以正衣冠；以古为镜，可以知兴替；以人为镜，可以明得失。融汇东汉三国、西晋、五胡十六国、东晋、南北朝、北魏、东西魏、周齐、大隋统一、隋末崩塌、唐初贞观四百四十九位古典先贤与一百位近代西方风云人物 · 五百四十九位人物相似度测算与学戒大略。",
      ...
      history_panorama_title: "四、全景历史人物长卷（549位历史人物名录）",
      history_counter_badge: "共收录 549 位风云人物",
    ...
    en: {
      ...
      app_subtitle: "Precise Astronomical Astrometry & Solar Terms · Built on Wave Mechanics, Cosmobiology & Harmonic Dynamics",
      ...
      advisor_tab_chat: "Advisor Dialogue",
      advisor_tab_ledger: "Action Ledger",
      advisor_back_to_chat: "Back to Dialogue",
      advisor_prompts_hint: "Instant strategic entry points for real dilemmas",
      advisor_ledger_btn: "Action Ledger",
      advisor_ledger_title: "Closed-Loop Action Ledger",
      advisor_ledger_sub: "Tracks micro-action execution and dynamically calibrates advisor tactical impedance",
      advisor_ledger_stats_total: "Total",
      advisor_ledger_stats_pending: "Pending",
      advisor_ledger_stats_executed: "Executed",
      advisor_ledger_stats_eased: "Eased",
      advisor_ledger_stats_blocked: "Blocked",
      advisor_ledger_stats_neutral: "Neutral",
      advisor_ledger_clear: "Clear Ledger",
      advisor_ledger_empty: "No micro-actions recorded yet. Actions generated by the advisor will appear here.",
      advisor_tool_audit_title: "Deterministic Tool Audit",
      advisor_tool_audit_sub: "Pure mathematical & canonical derivation · Zero black-box hallucination",
      advisor_feedback_prompt: "1-Click Feedback",
      advisor_feedback_eased: "Eased",
      advisor_feedback_blocked: "Blocked",
      advisor_feedback_neutral: "Neutral",
      advisor_recalibration_title: "Dynamic Recalibration Active",
      advisor_situation_align_title: "Situational Reality Alignment",
      advisor_situation_align_prompt: "Do these tactical strategies and micro-actions align with your real-world circumstances (budget, runway, office dynamics, constraints)?",
      advisor_situation_agree_btn: "Well-Aligned, Execute as Planned",
      advisor_situation_refine_btn: "Describe Current Situation for Customization",
      advisor_situation_input_label: "Describe your specific current constraints or dilemma (e.g. runway, aggressive boss, family pressure):",
      advisor_situation_placeholder: "e.g. Dept is laying off people, 5 months savings left, toxic manager...",
      advisor_situation_submit_btn: "Generate Bespoke Situation Strategy",
      advisor_situation_cancel_btn: "Cancel",
      advisor_situation_confirmed: "Confirmed aligned with current real-world circumstances.",
      advisor_situation_badge: "Situational",
      advisor_situation_active_prefix: "Active Real-World Situation Context:",
      advisor_situation_banner_hint: "Describe your specific circumstances (financial runway, political friction, time constraints) for bespoke tactical execution.",
      advisor_situation_btn_input: "Input Situation Context",
      advisor_situation_btn_update: "Update Situation",
      advisor_ledger_filter_all: "All",
      advisor_ledger_filter_pending: "To-Do Actions",
      advisor_ledger_filter_executed: "Completed",
      advisor_ledger_filter_situational: "Situational",
      advisor_ledger_mark_all_done: "Mark All Done",
      advisor_ledger_add_custom: "Add Custom Action",
      advisor_ledger_custom_title: "Add Custom Micro-Action (Generates Dedicated Checkbox)",
      advisor_verifier_title: "Micro-Action Verifier & Customization",
      advisor_verifier_prompt: "These action items may not 100% reflect your current situation. Have anything you want to add, adjust, or refine?",
      advisor_verifier_confirm_btn: "Matches Reality, No Additions Needed",
      advisor_verifier_add_btn: "Add / Modify Custom Action",
      advisor_verifier_input_label: "Enter custom micro-action to add to your checklist:",
      advisor_verifier_placeholder: "e.g. Schedule 45-min mock interview every Tuesday, avoid discussing project with toxic colleague...",
      advisor_verifier_notify_advisor: "Ask advisor to recalibrate strategy around this",
      advisor_verifier_submit_btn: "Add Action & Update Checklist",
      career_subpage_nav_label: "3 High-Dimension Workplace Strategic Hubs:",
      career_tab_title_overview: "Career & Wealth Dynamics",
      career_tab_badge_overview: "Blueprint",
      career_tab_desc_overview: "Upward Management · Peer Firewalls · Wealth Timing",
      career_tab_title_simulator: "Dual-Track Decision Simulator",
      career_tab_badge_simulator: "Simulation",
      career_tab_desc_simulator: "Track A vs B Clash · Win Rates & Energy Ratio",
      career_tab_title_matrix: "Political Game Matrix",
      career_tab_badge_matrix: "Power Graph",
      career_tab_desc_matrix: "3-5 Actors Non-Zero-Sum · Ten Gods Power Graph",
      career_subpage_note: "3 Strategic Hubs · Instant Access",
      ...
      sim_subpage_nav_label: "⚖️ Decision Sandbox Dedicated Subpages:",
      sim_tab_title_sandbox: "Dual-Track Scenario Sandbox",
      sim_tab_badge_sandbox: "Clash Projector",
      sim_tab_title_georesonance: "Geographic Field & Workplace Ecosystem",
      sim_tab_badge_georesonance: "Eco Positioning",
      sim_tab_title_fengshui: "Spatial Feng Shui & 10 Practical Remedies",
      sim_tab_badge_fengshui: "Spatial Flow",
      sim_subpage_note: "Architected on 12 Canons subpage paradigm · 3 Strategic Decision Hubs",
      tab_fric_specs: "Factory Mind Manual",
      tab_fric_specs_badge: "Specs Check",
      tab_fric_zen: "Zen-Dao Trinity",
      tab_fric_zen_badge: "Sutras & Dao",
      tab_fric_canons: "8 Canons Antidotes",
      tab_fric_canons_badge: "Classics",
      tab_fric_triggers: "Stress Triggers",
      tab_fric_triggers_badge: "Red Lines",
      tab_fric_protocols: "Three-Tier Reset",
      tab_fric_protocols_badge: "Reboot",
      tab_fric_habits: "Five-Element Habits",
      tab_fric_habits_badge: "Somatic",
      tab_fric_iching: "Zhou Yi 64 Hexagrams",
      tab_fric_iching_badge: "Divination",
      tab_fric_all: "Full Dossier",
      tab_fric_all_badge: "All Sections",
      ...
      btn_ribbon_ledger: "📋 Action Checklist",
      btn_ribbon_ledger_text: "Action Checklist",
      floating_ledger_btn: "Action Checklist",
      deities_section_title: "Four Sovereign Benefic Vectors Matrix (Archetypal Resonances)",
      deities_section_sub: "Synthesizing Western benefic vectors and classical archetypes: Sovereign Benefactor, Academic Acuity, Amorous Affinity, and Dynamic Mobility vector activations",
      ...
      // In-Page Rectification Workbench Keys
      rectify_inpage_title: "Event-Based Rectification · Natal Accuracy Calibration Hub",
      seal_rectification: "Rectification",
      rectify_inpage_sub: "If core natal patterns, kinship, or life trajectory do not match your lived experience due to birth hour ambiguity, enter 2-3 confirmed milestones to reverse-calculate the MAP true birth hour and recalibrate the chart.",
      btn_toggle_rectify_workbench: "Expand Calibration Workbench",
      btn_toggle_rectify_workbench_collapse: "Collapse Calibration Workbench",
      rectify_rationale_title: "Why Might Natal Deduction Deviate? (Hour Cusp & Rectification Theory)",
      rectify_rationale_desc: "In accordance with Martin Gansten's Primary Directions (1° RA = 4 minutes = 1 solar year) and Noel Tyl's Solar Arc calibration, exact temporal cusps dictate life trajectory. Because each double-hour pillar spans 120 minutes, births near boundaries or uncorrected for true solar time alter the angular ascendant and governing patterns. Event-based rectification applies Bayesian posterior probability across historical milestones to recover the true natal coordinates with mathematical certitude.",
      rectify_step1_sync_hint: "Auto-Synced",
      btn_load_sample_events: "⚡ Load Typical Sample Events",
      rectify_approx_hour: "Approximate Birth Time Range",
      rectify_opt_all_hours: "Scan All 12 Double-Hours (24h Full Scope)",
      rectify_opt_morning: "Morning (Mao, Chen, Si 05:00-11:00)",
      rectify_opt_afternoon: "Afternoon (Wu, Wei, Shen 11:00-17:00)",
      rectify_opt_evening: "Evening & Nightfall (You, Xu, Hai 17:00-23:00)",
      rectify_opt_night: "Midnight & Dawn (Zi, Chou, Yin 23:00-05:00)",
      rectify_event_year: "Calendar Year",
      rectify_event_type: "Milestone Event Category",
      rectify_event_desc: "Event Notes (Optional)",
      rectify_type_exam: "Academic Triumph / Prestigious Exam (Academic/Exam)",
      rectify_type_illness: "Major Surgery / Accidental Injury (Surgery/Illness)",
      rectify_type_marriage: "Marriage / Soulmate Commitment (Marriage/Union)",
      rectify_type_child: "Childbirth / Family Addition (Childbirth)",
      rectify_type_career_jump: "Major Career Promotion / Executive Leap (Major Promotion)",
      rectify_type_wealth_loss: "Financial Loss / Investment Setback (Wealth Loss/Debt)",
      rectify_type_relocation: "Cross-Border Relocation / Major Move (Relocation/Move)",
      btn_run_rectification: "Compute Bayesian MAP Rectification",
      rectify_check_prompt: "Does the deduction differ from your actual life experience?",
      rectify_check_tag: "ACCURACY CALIBRATION",
      ...
      phase_portrait_title: "Life-Chrono Phase Space & 3D Spiral Manifold",
      phase_portrait_sub: "Dynamic 3D helical trajectory anchored on Day Master baseline: tracking lifetime momentum, spiral ascent, and grounding cycles from Age 1 origin",
      phase_param_rigidity: "Pattern Rigidity (a · Day Master Resilience):",
      phase_param_bifurcation: "Bistability (b · Phase Leap Potential):",
      phase_param_bias: "Decadal Luck Bias (c · External Transit Momentum):",
      phase_param_damping: "Damping Coefficient (γ · Buffer Sanctuary):",
      phase_btn_reset: "Reset Dynamics",
      phase_legend_axis_x: "X Axis: Chronological Time Progression (1y -> 100y) & Energy State",
      phase_legend_axis_v: "Y Axis: Potential Elevation & Momentum (Spiral Ascent / Grounding)",
      phase_legend_origin: "1y Origin · Natal Dawn",
      phase_legend_spring: "1-25y Spring",
      phase_legend_summer: "26-50y Prime",
      phase_legend_autumn: "51-75y Harvest",
      ...
      dossier_download_btn: "📥 Download 9-Page A4 PDF",
      dossier_print_btn: "🖨️ Print / Save as PDF",
      dossier_close_btn: "Close Preview",
      dossier_generating: "⏳ Compiling 9-Page Qin Tian Jian Imperial Celestial Blueprint A4 PDF...",
      dossier_generating_single: "⏳ Compiling Single-Page (Page 1) Table of Contents A4 PDF...",
      ...
      dossier_subtitle: "Western Wave Mechanics & Cosmobiology Synthesis (Addey, Ebertin, Rudhyar & Hand)",
      ...
      portal_card10_desc: "Eastern Han to Early Tang & Modern West · 549 Historical Titans · Personality, Archetype & Deeds · Similarity & Guidance",
      portal_history_title: "Historical Figures Reference & Mirror (East & West)",
      portal_history_desc: "Eastern Han to Early Tang 449 Classical Figures & 100 Modern Western Titans (1800-1945) · 549 Archetypes",
      history_banner_title: "Historical Figures Reference · Archetype Mirror",
      history_banner_desc: "Using bronze as a mirror to dress; using history to know the rise and fall; using persons to discern right and wrong. Comparing your Day Master and patterns against 549 historical titans (including 100 modern Western figures) to derive strategic guidance and behavioral circuit-breakers.",
      ...
      history_panorama_title: "4. Historical Panorama (549 Historical Figures Catalog)",
      history_counter_badge: "549 Historical Titans Curated",
      ...
      tab_definitions_desc: "Classical archetypal exegesis synthesized with C.G. Jung's behavioral typologies, Reinhold Ebertin's functional axes, and pragmatic workplace directives for executive strategy.",
      ...
      portal_hero_subtitle: "Exploring Celestial Dynamics & Human Destiny · Synthesizing Harmonic Wave Mechanics, Midpoint Dynamics & Classical Canons",
      ...
      portal_zen_quote: "'To comprehend universal wave dynamics and destiny, first discern fundamental phase equilibrium and cosmic harmony.' —— John M. Addey & Dane Rudhyar",
      ...
      pareto_eight_canons_tag: "Wave Mechanics · Astrometeorology · Cosmobiology · Harmonics · Composite Vectors · Systemic Medicine",
      ...
      portrait_desc: "Synthesizing Addey Harmonics, Ebertin Cosmobiology, Rudhyar Phase Dynamics & Hand Composite Vectors · Intelligent pattern diagnostics, vigor scoring, seasonal regulation & holistic life blueprint",
