...
class PortraitEngine {
  ...
  static diagnoseMentalFriction(bazi, vigor, patterns, climate) {
    ...
    const classicalCanonsManual = [
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: As in Reinhold Ebertin\'s Cosmobiology and structural midpoint theory, extreme systemic tension creates the crucible for breakthrough once the stabilizing focal point (the Guarding Minister) is activated. When you identify your primary stabilizing vector (e.g. Resource structure to anchor turbulent Output, or disciplined focus to absorb crisis friction), dynamic resistance instantly converts into sovereign mastery. Anchor firmly in your natal strengths instead of imitating foreign archetypes.',
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: In alignment with C.G. Jung\'s archetypal typologies and differentiated functions, your acute sensitivity, perfectionism, and aloofness are simply the reverse side of exceptional genius. Dull minds do not possess the computational bandwidth to ruminate. Embrace your elemental idiosyncrasies rather than forcing false superficial conformity. Polarized talent is the exact edge that breaches monopolistic frontiers.',
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: In Ptolemaic and classical astrological terms, "Purity" denotes an unblemished directional focus, whereas "Turbidity" reflects discordant planetary aspects pulling in contradictory directions—such as craving radical autonomy while agonizing over public approval. Dissolving conflicting dual standards instantly purifies your operational engine, eliminating cognitive rumination.',
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: As in nonlinear thermodynamics and crisis theory, systemic tension and severe friction are the indispensable crucibles for evolutionary breakthrough. Mediocre systems experience zero friction and achieve zero greatness; sovereign leaders possess intense structural stress vectors that force systemic transformation. Existential friction is the precise propellant of your highest competitive edge.',
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: In Robert Hand\'s Composite Dynamics and psychological boundary theory, eighty percent of interpersonal friction stems from unconscious projection. When another person reacts, an insecure psyche projects an entire conflict. Setting clear psychological perimeters and maintaining internal sovereign balance neutralizes external volatility completely.',
      ...
      },
      {
        ...
        vernacularEn: '[Vernacular Modern Exegesis]: In Hellenistic Time-Lord doctrine and Jim Lewis\' Astro*Carto*Graphy, individual momentum achieves maximum velocity when synchronized with macroscopic generational cycles. Cease viewing yourself as an isolated particle; aligning your trajectory with civilizational macro-cycles (such as the contemporary computational and AI synthesis era) dissolves personal friction and multiplies strategic impact ten-thousand-fold.',
  ...
  static generateGrandPicture(bazi, vigor, patterns, climate, canons, spouse, children, parents, environment) {
    ...
    const kinshipEn = `Robert Hand's Composite Vector Synthesis and Reinhold Ebertin's relational midpoint axes establish that worldly command requires a stabilized structural counter-pole. Day Branch spouse palace sits on [${spBranchEn}], manifesting the [${spArchEn}] archetype. The partner acts as an unshakeable breakwater and gravitational ballast—anchoring assets, mitigating emotional volatility, and providing structural equilibrium against external turbulence. Hour Pillar [${hourPillarEn}] governs offspring, manifesting the [${chArchEn}] archetype (${chTalentEn}). Descendants channel the native's intense vital output into cultural and entrepreneurial brilliance, crowning late-life fruition.`;
    ...
    const eraEn = `Michael Erlewine's Local Space horizon vectors and Jim Lewis' Astro*Carto*Graphy establish that spatial orientation modulates personal potential along geographic planetary lines. Civilization is moving through a transformative macro-cycle (2024–2043) centered on artificial intelligence, computational networks, and cognitive renaissance. The native's strategic intellect forms an organic thermodynamic equilibrium with this innovative wave. Geographically aligning along the local horizon vectors of [${idealGeoEn}] (optimal spatial nodes: ${targetCitiesEn}) while deploying digital and computational leverage will amplify sovereign impact tenfold across the coming two decades.`;
